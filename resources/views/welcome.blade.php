...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{asset('../resources/assets/')}}/styles/jquery.sliderTabs.min.css">
        <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7.1/jquery.min.js"></script>
        <script src="{{asset('../resources/assets/')}}/jquery.sliderTabs.min.js"></script>
        {!! Html::style(asset('master.css')) !!}
    ...
    <body>
        <div class="container">
            <h2>VAF Application Form</h2>
             {!! Form::open(array('url' => 'app/submit', 'method' => 'post','class'=>'row','id'=>'submit_property_form','file'=>true, 'enctype'=>"multipart/form-data" )) !!}
<div id="mySliderTabs">
